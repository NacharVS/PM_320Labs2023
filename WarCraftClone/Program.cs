...
{
    Footman footman = new Footman(logger,"Footman - 1",200.0,10,1,200.0,35.0,10.0,0.1,4,0.1);
...
//--Check using spells--
 {
     Mage mage2 = new Mage(logger,"Mage - 2", 100.0, 10, 1, 100, 50.0, 7, 0.3, 2, 3.0, 100);
