...
namespace WPFcharacteristic.WPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Entity_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            HealthArmor.Text = "0";
            ManaArmor.Text = "0";
            PhysicalAttackArmor.Text = "0";
            MagicAttackArmor.Text = "0";
            PhysicalDefenseArmor.Text = "0";
            MagicDefenseArmor.Text = "0";

            Helms.Items.Clear();
            Breastplates.Items.Clear();
            Sabatons.Items.Clear();
        ...
        private void SaveDataBase_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                MongoDBwpf<Entity>.AddToDataBase(entity, "Units");
        ...
        private void ReplaceDataBase_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                MongoDBwpf<Entity>.ReplaceByName(entity.Name, entity, "Units");
                MessageBox.Show("Готово!");
            }
            catch (Exception)
            {
        ...
        private void InsertDataBase_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Refresh();
                RefreshEquipment(entity.Helmet);
                RefreshEquipment(entity.BodyArmor);
                RefreshEquipment(entity.Feet);
